...
const EDIT = [
    ...
    // from 15.0 the re-inked run cuts every 2 frames (white ring radii in px measured per
    // frame, 360–383: it grows ≈ 16 px per shot and ≈ 85 px within one); 15.0–15.5 swap pink and blue and
    ...
    [15.0, 'full', 'phone', { ring: true, ringR: [278, 356], inks: SWAP_PB, zoom: [1.07, -29.6, -29.6] }],
    [15.083, 'full', 'turntable', { ring: true, ringR: [296, 376], inks: SWAP_PB, zoom: [1.08, -37.0, -40.7] }],
    [15.167, 'full', 'frogs', { ring: true, ringR: [312, 392], inks: SWAP_PB, zoom: [1.082, -49.3, -32.9] }],
    [15.25, 'full', 'bats', { ring: true, ringR: [326, 410], inks: SWAP_PB, zoom: [1.1, -63.0, -74.1] }],
    [15.333, 'full', 'wave', { ring: true, ringR: [342, 428], inks: SWAP_PB }],
    [15.417, 'full', 'cat', { ring: true, ringR: [358, 446], inks: SWAP_PB, zoom: [1.08, -48, -43] }],
    [15.5, 'full', 'sunflower', { ring: true, ringR: [374, 462], inks: SWAP_PB, zoom: [1.13, -68.5, -77.8] }],
    [15.583, 'full', 'radio', { ring: true, ringR: [390, 478], inks: SWAP_PB, zoom: [1.169, -91.9, -86.4] }],
    [15.667, 'full', 'fireworks', { ring: true, ringR: [406, 498], inks: SWAP_PB, zoom: [1.19, -95.0, -95.0] }],
    [15.75, 'full', 'hummingbird', { ring: true, ringR: [422, 518], inks: SWAP_PB, zoom: [1.08, -40.0, -40.0] }],
    [15.833, 'full', 'kettle', { ring: true, ringR: [438, 536], inks: SWAP_PB, zoom: [1.06, -30.0, -30.0] }],
    [15.917, 'full', 'ferris', { ring: true, ringR: [454, 552], inks: { pink: 'blue', yellow: 'blue' }, zoom: [1.15, -75.0, -75.0] }],
