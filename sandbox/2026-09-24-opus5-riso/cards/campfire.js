...
CARDS.campfire = (press, t) => {
    ...
    // reference) live in private/campfire-data.js, never committed; the card falls back to its
    // described shapes without them
    const D = (typeof G5DATA !== 'undefined' && G5DATA.campfire) || {};
    const TONE = D.tone;
    ...
    U.px(press, () => {
        ...
        const outer = D.flame ?? [[322, 800], [330, 660], [380, 665], [405, 530], [440, 545], [510, 416], [525, 520], [600, 316], [636, 520], [640, 640], [690, 553], [720, 690], [718, 800]];
        eraseIn(all, (g) => U.smooth(g, outer) || g.fill());
        U.fill(pink, outer, T(1), true);
        U.fill(yel, outer, T(1), true);
        const heart = D.heart ?? [[387, 800], [400, 670], [434, 590], [450, 700], [470, 530], [530, 570], [595, 438], [590, 600], [671, 692], [629, 800]];
