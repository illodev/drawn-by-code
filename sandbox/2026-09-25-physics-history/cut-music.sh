...
# not committed): 57.8 s long; ducked while the camera falls into the black hole and the
...
ffmpeg -v error -y -i music-eleven.mp3 -af "atrim=0:57.8,asetpts=PTS-STARTPTS,\
