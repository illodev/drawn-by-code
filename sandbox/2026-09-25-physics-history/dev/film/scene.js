...
// (31–38.6), Einstein (38.6–47.2), Schrödinger (47.2–58.0); the cat in every scene.
const DIR = 'sandbox/2026-09-25-physics-history/';
const PLAN = [[0, 3.0, 'titleIntro'], [3.0, 15.8, 'galileoRoof'], [15.8, 22.8, 'newtonApple'], [22.8, 34.0, 'faradayCoil'], [34.0, 41.6, 'curieRadium'], [41.6, 50.2, 'einsteinRay'], [50.2, 61.0, 'schrodingerBox'], [61.0, 67.0, 'title']];
Motion.scene({
    fps: 24, duration: 67.0, logical: [1600, 900], bpm: 117.5, audio: { mix: 'mix.wav' },
    uses: ['styles/risograph/riso.js', DIR + 'kit.js', DIR + 'cast.js', DIR + 'sets.js', DIR + 'earth.js', DIR + 'figure.js', DIR + 'cat.js', DIR + 'scope3d.js', DIR + 'head-galileo.js', DIR + 'hands-galileo.js', DIR + 'coil3d.js', DIR + 'lab-faraday.js',
        ...
        DIR + 'segments/curie.js', DIR + 'segments/curie-radium.js', DIR + 'segments/einstein.js', DIR + 'segments/einstein-ray.js', DIR + 'segments/schrodinger.js', DIR + 'segments/schrodinger-box.js', DIR + 'segments/title.js'],
