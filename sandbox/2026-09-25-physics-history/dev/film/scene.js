...
const PLAN = [[0, 12.8, 'galileoRoof'], [12.8, 19.8, 'newtonApple'], [19.8, 31.0, 'faradayCoil'], [31.0, 38.6, 'curieRadium'], [38.6, 47.2, 'einsteinRay'], [47.2, 58.0, 'schrodingerBox']];
Motion.scene({
    fps: 24, duration: 58.0, logical: [1600, 900], bpm: 117.5, audio: { mix: 'mix.wav' },
