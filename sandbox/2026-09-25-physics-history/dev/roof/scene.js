...
Motion.scene({
    ...
    uses: ['styles/risograph/riso.js', DIR + 'kit.js', DIR + 'cast.js', DIR + 'sets.js', DIR + 'earth.js', DIR + 'figure.js', DIR + 'cat.js', DIR + 'scope3d.js', DIR + 'head-galileo.js', DIR + 'hands-galileo.js',
