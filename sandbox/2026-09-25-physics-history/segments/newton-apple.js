...
(() => {
    ...
    const CH = {
        ...
        nk: [[0, 0.4], [1.46, 0.4], [1.5, 0.75], [1.62, -0.2], [1.9, 0.12], [2.2, 0.25], [2.55, 0.3], [2.8, 0.1], [3.3, 0.3], [3.62, 0.3], [3.95, 0.05], [4.05, 0.05], [4.3, 0.2], [4.47, 0.28], [4.57, -0.42], [4.78, -0.3], [5.0, -0.2], [5.3, -0.6], [7, -0.62]],
        ...
        shut: (t) => t >= 1.5 && t < 2.2,
        gripN: (t) => (t >= 1.75 && t < 2.4 ? 'head' : t >= 2.4 && t < 3.15 ? 'knee' : t >= 3.15 && t < 3.8 ? 'relax' : t < 3.95 ? 0.75 : t < T.release ? 'apple' : 0.05),
        gripF: (t) => (t >= 4.7 && t < 5.45 ? 'open' : t < 3.05 ? 0.5 : 0.3),
    };
    ...
    CH.hN = [[0, [560, 598]], [1.46, [560, 598]], [1.5, [584, 556]], [1.62, [520, 520]], [1.8, [448, 404]], [1.9, [460, 398]], [2.0, [436, 404]], [2.1, [458, 398]], [2.2, [438, 404]], [2.32, [452, 400]], [2.55, [560, 610]], [2.8, [600, 650]], [3.05, [590, 560]], [3.3, [575, 470]], [3.62, [640, 470]], [3.8, [L(690, GRAB[0], 0.6), L(560, GRAB[1], 0.6)]], [3.95, GRAB], [4.05, GRAB], [4.3, [745, 205]], [4.47, [742, 210]], [4.62, [735, 215]], [4.78, [455, 95]], [4.92, [560, 70]], [5.0, [880, 40]], [5.1, [960, 230]], [5.25, [905, 420]], [5.6, [830, 380]], [7, [830, 380]]];
