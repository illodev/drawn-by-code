// Paper-cutout style template: a piece drops in, a phrase writes itself and gets underlined.
// engine/new.mjs copies it as the scene.js of every new experiment.
Motion.scene({
    fps: 24,
    duration: 4,
    logical: [1600, 900],
