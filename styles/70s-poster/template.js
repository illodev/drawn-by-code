// 70s poster style template: spinning rays, an undulating shape with echoes and
// a title that drops in and melts.
Motion.scene({
    fps: 24,
    duration: 4,
    logical: [1600, 900],
    uses: ['styles/70s-poster/kit.js'],
    fonts: [{ family: 'Shrikhand', src: 'fonts/Shrikhand-latin.woff2' }],
    bpm: 120,
    shots: [[0, 4, 'Template']],

    draw(g, t, env) {
        const P = Groovy.PAL.acid, E = Ease;
